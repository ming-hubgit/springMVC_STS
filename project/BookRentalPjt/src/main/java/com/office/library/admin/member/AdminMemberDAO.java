...
public class AdminMemberDAO {
	...
	public int insertAdminAccount(AdminMemberVO adminMemberVO) {
		...
		sql += "a_m_gender, ";//insert into tbl_admin_member(a_m_approval, a_m_id, a_m_pw, a_m_name, a_m_gender
		args.add(adminMemberVO.getA_m_gender());
		
		sql += "a_m_part, ";//insert into tbl_admin_member(a_m_approval, a_m_id, a_m_pw, a_m_name, a_m_gender, a_m_part
